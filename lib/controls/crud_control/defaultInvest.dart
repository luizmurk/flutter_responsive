...
class DefaultInvest extends StatefulWidget {
  final int number;
  final int date;
  final int cvv;
  ...
  DefaultInvest(this.number, this.date, this.cvv, this.formData, this.formkey);

  @override
  _DefaultInvestState createState() => _DefaultInvestState();
}

class _DefaultInvestState extends State<DefaultInvest> {
  @override
