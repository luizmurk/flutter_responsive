...
class FundBankAccount extends StatefulWidget {
  final int number;
  final int date;
  final int cvv;
  ...
  @override
  _FundBankAccountState createState() => _FundBankAccountState();
}

class _FundBankAccountState extends State<FundBankAccount> {
  @override
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: buttonTextReal('Fund Bank Account'),
        ),
      ),
    );
  }
